...
import com.redoct.blackboard.adapter.CompletedStickyNoteAdapter;
...
public class CompletedStickyNoteFragment extends Fragment {

	private PullToRefreshGridView mPullToRefreshGridView;
	private CompletedStickyNoteAdapter mStickyNoteAdapter;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		mStickyNoteAdapter=new CompletedStickyNoteAdapter(getActivity(),mStickyNoteInfos){
	...
	public void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if (requestCode == Constant.RESULT_CODE_STICKY_NOTE_MODIFY) {
			...
			Log.e("zyf", "Constant.RESULT_CODE_STICKY_NOTE_MODIFY......from CompletedStickyNoteFragment.....");
			...
			if(deleted){ //已经删除
				...
				if(!stickyNoteInfo.isCompleted()){   //已经“未完成”，需要从列表中删除
	...
	private void loadData(){
		...
		QueryAllStickyNotesTask mQueryAllStickyNotesTask=new QueryAllStickyNotesTask(time,mode,mGreenBoardInfo.getId(),true){
